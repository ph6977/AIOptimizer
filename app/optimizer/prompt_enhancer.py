...
class PromptEnhancer:
    ...
    def enhance(self, messages: list[ChatMessage], task_type: TaskType | None = None) -> list[ChatMessage]:
        """增强消息列表：注入/替换系统提示词"""
        if not messages:
            return messages
        ...
        # 获取增强系统提示词
        enhanced_system = ENHANCED_SYSTEM_PROMPTS.get(task_type, ENHANCED_SYSTEM_PROMPTS["chat"]) + QUALITY_GUIDELINES
